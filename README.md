...
- 📱 **Design responsivo**: adaptável a diferentes tamanhos de tela (desktop, tablet, smartphone) utilizando media queries e layout flexível.
- 🎨 **Visual limpo e moderno**: pensado para facilitar a leitura e navegação.
